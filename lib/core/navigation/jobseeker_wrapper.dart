...
class JobseekerWrapper extends StatefulWidget {
  const JobseekerWrapper({super.key});

  @override
  State<JobseekerWrapper> createState() => _JobseekerWrapperState();
}

class _JobseekerWrapperState extends State<JobseekerWrapper> {
  ...
  void initState() {
    ...
    Future.delayed(const Duration(milliseconds: 1250), () {
      if (mounted) {
        NotificationService.instance.checkPendingNotification();
      }
    });
  }
