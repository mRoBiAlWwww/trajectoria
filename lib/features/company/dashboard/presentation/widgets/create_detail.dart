...
class _CreateDetailWidgetState extends State<CreateDetailWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      ...
      child: BlocBuilder<CreateCompImageCubit, CreateCompImageState>(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      onChanged: (value) {
                        context.read<CreateCompetitionCubit>().setTitle(value);
                      },
                    ...
                    Container(
                      ...
                      child: TextField(
                        ...
                        onChanged: (value) => {
                          context.read<CreateCompetitionCubit>().setDescription(
                            value,
                          ),
                        },
                        decoration: InputDecoration(
                              ...
                              BlocListener<SubmissionCubit, SubmissionState>(
                                listener: (context, state) {
                                  if (state is SuccessUpload) {
                                    context
                                        .read<CreateCompetitionCubit>()
                                        .addGuidebookItemList(state.files);
